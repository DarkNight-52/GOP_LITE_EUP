...
files {
  'mp_m_freemode_01_mp_m_eup_n.meta',
  'mp_f_freemode_01_mp_f_eup_n.meta'
  -- 'pedalternatevariations.meta',
  -- 'first_person_alternates.meta'
}

data_file 'SHOP_PED_APPAREL_META_FILE' 'mp_m_freemode_01_mp_m_eup_n.meta'
data_file 'SHOP_PED_APPAREL_META_FILE' 'mp_f_freemode_01_mp_f_eup_n.meta'
